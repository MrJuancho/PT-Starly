    ...
    return _startPressed
        ...
        : _activityFinished
            ...
            : InstruccionesWidget.show(context, _estadisticsController, presionado,
                'Selecciona al personaje que no pertenece a la epoca historica de México.', screenWidth, screenHeight);
  }
                              ...
                              onTap: () async {
                                ...
                                if (correctas == 4) {
                                  ...
                                  _estadisticsController.registroResultados(
                                      18, intentos, ayudas, _estadisticsController.formatMilliseconds());
                                } else {
                                  correctas += 1;
                                }
                              },
