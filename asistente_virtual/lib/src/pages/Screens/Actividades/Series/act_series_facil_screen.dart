...
class ActSeriesFacilPage extends StatefulWidget {
  ...
  @override
  _ActSeriesFacilState createState() => _ActSeriesFacilState();
}

class _ActSeriesFacilState extends State<ActSeriesFacilPage> {
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    ...
                                                    if (correctas == 5) {
                                                      ...
                                                      resultados();
                                                      _estadisticsController.registroResultados(37, intentos, ayudas,
