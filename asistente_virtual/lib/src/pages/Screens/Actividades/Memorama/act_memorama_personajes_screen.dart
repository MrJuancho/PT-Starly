    ...
    if (flippedCards.length < 2) {
      ...
      if (flippedCards.length == 2) {
        ...
        if (flippedStatus.every((status) => status == true)) {
          ...
          _estadisticsController.registroResultados(69, intentos, ayudas, _estadisticsController.formatMilliseconds());
        }
      }
    }
  }
    ...
    return _startPressed
        ...
        : _activityFinished
            ...
            : InstruccionesWidget.show(
                ...
                presionado,
                'Hacer pares de personajes celebres que participaron y fueron parte de la vida despues de la independencia.',
                screenWidth,
                screenHeight);
  }
