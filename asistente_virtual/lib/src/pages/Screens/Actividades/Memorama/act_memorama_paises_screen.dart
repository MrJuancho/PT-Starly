...
class ActMemoramaPaisesPage extends StatefulWidget {
  ...
  @override
  _ActMemoramaPaisesState createState() => _ActMemoramaPaisesState();
}

class _ActMemoramaPaisesState extends State<ActMemoramaPaisesPage> {
  ...
  List<String> cardImages = [
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais1.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais2.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais3.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais4.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais5.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais6.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais7.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais8.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Paises/pais9.png',
    ...
    if (flippedCards.length < 2) {
      ...
      if (flippedCards.length == 2) {
        ...
        if (flippedStatus.every((status) => status == true)) {
          ...
          _estadisticsController.registroResultados(32, intentos, ayudas, _estadisticsController.formatMilliseconds());
        }
      }
    }
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Marquee(
            ...
            child: Text(
              'Memorama de delimitaciones de paises',
