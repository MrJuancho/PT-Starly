...
class ActMemoramaSistemaSolarPage extends StatefulWidget {
  const ActMemoramaSistemaSolarPage({
    Key? key,
    String? counter,
  ...
  @override
  _ActMemoramaSistemaSolarState createState() => _ActMemoramaSistemaSolarState();
}

class _ActMemoramaSistemaSolarState extends State<ActMemoramaSistemaSolarPage> {
    ...
    if (flippedCards.length < 2) {
      ...
      if (flippedCards.length == 2) {
        ...
        if (flippedStatus.every((status) => status == true)) {
          ...
          _estadisticsController.registroResultados(28, intentos, ayudas, _estadisticsController.formatMilliseconds());
        }
      }
    }
  }
    ...
    return _startPressed
        ...
        : _activityFinished
            ...
            : InstruccionesWidget.show(
                context, _estadisticsController, presionado, 'Buscar los planetas del sistema solar en un memorama');
  }
