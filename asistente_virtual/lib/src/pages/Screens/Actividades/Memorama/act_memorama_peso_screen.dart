...
class ActMemoramaPesoPage extends StatefulWidget {
  const ActMemoramaPesoPage({
    Key? key,
    String? counter,
  })  : counter = counter ?? '0',
        super(key: key);
  ...
  @override
  _ActMemoramaPesoState createState() => _ActMemoramaPesoState();
}

class _ActMemoramaPesoState extends State<ActMemoramaPesoPage> {
  ...
  List<String> cardImages = [
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida1.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida2.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida3.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida4.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida5.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida6.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida7.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida8.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida9.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida10.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida1.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida2.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida3.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Peso/medida4.png',
    ...
    if (flippedCards.length < 2) {
      ...
      if (flippedCards.length == 2) {
        ...
        if (flippedStatus.every((status) => status == true)) {
          ...
          _estadisticsController.registroResultados(27, intentos, ayudas, _estadisticsController.formatMilliseconds());
        }
      }
    }
  }
    ...
    return _startPressed
        ...
        : _activityFinished
            ...
            : InstruccionesWidget.show(context, _estadisticsController, presionado,
                'Encontrar diferentes materiales y sus diferentes estados fisicos.', screenWidth, screenHeight);
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Marquee(
            ...
            child: Text(
              'Masa, volúmen y sus variaciones',
        ...
        floatingActionButton: AyudasWidget.build(context, _estadisticsController, 22, incrementarAyudas),
