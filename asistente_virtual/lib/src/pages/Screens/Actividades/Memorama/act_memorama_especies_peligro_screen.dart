...
class ActMemoramaEspeciosPeligroPage extends StatefulWidget {
  const ActMemoramaEspeciosPeligroPage({
    Key? key,
    String? counter,
  ...
  @override
  _ActMemoramaEspeciosPeligroState createState() => _ActMemoramaEspeciosPeligroState();
}

class _ActMemoramaEspeciosPeligroState extends State<ActMemoramaEspeciosPeligroPage> {
  ...
  List<String> cardImages = [
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An1.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An2.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An3.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/an4.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/an5.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/an6.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An1.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An2.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/An3.png',
    'assets/images/Actividades/Memorama/Act_Memorama_Especies_Peligro/an4.png',
    ...
    if (flippedCards.length < 2) {
      ...
      if (flippedCards.length == 2) {
        ...
        if (flippedStatus.every((status) => status == true)) {
          ...
          _estadisticsController.registroResultados(26, intentos, ayudas, _estadisticsController.formatMilliseconds());
        }
      }
    }
  }
    ...
    return _startPressed
        ...
        : _activityFinished
            ...
            : InstruccionesWidget.show(
                context, _estadisticsController, presionado, 'Se muestra una variedad de especies en peligro de extincion, hacer pares');
  }
  ...
  Widget _actividad(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: AyudasWidget.build(context, _estadisticsController, 21, incrementarAyudas),
